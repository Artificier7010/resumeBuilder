...
const Formpage = () => {
  ...
  //   axios.post('http://localhost:8000/build/resume', { ...formData, refId: uuid4() })
  //     .then(res => {
  //       console.log(res);
  //     }).catch(err => {
  //       console.log(err);
      ...
      <div className="formpage-wrap">
        ...
        <div className="form-wrap">
          ...
          <div className="form-section">
            ...
            <br /><br />
            <button onClick={buildResume} className='btn btn-success btn-block'>Let's Build This</button>

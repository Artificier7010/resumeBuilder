...
export const { updateField, resetFormData, addQualificationValue,addSkills,removeSkills, addMoreQualifiFields,removeQualifiFields,addExperienceValue,addMoreExpFields,removeExpFields,updateExpDescription } = updateSlice.actions;